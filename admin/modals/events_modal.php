...
<!-- Start of modal -->
<div class="flex hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="event_modal">
    ...
    <!-- <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>s -->
            ...
            <div class="bg-white p-5 mx-5 my-5" style="max-width: 500px">
                <div class="flex justify-between items-center pb-8">
                    ...
                    <i class="fas fa-close text-gray-300 cursor-pointer" onclick="toggleModal('event_modal')"></i>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-center">
                            <div style="font-size: 14px">
                                <button type="button" onclick="toggleModal('event_modal')" class="px-6 py-2 bg-gray-100 rounded text-gray-500">
                                    Cancel
                                </button>

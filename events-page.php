...
<body>
    <div class="px-1 md:px-7 lg:px-7 shadow-sm">
        <div class="relative pt-6 px-4 sm:px-6 lg:px-8 pb-6">
          <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
            ...
            <div class="hidden md:block md:ml-8 md:pr-4 md:space-x-8">
              ...
              <?php
               if (isset($_SESSION['id']) && (isset($_SESSION['name'])))  {
                 echo '<a href="events-page.php" class="text-yellow-400 font-medium border-b-2 border-yellow-50 transition-all">Events</a>';

    ...
    <!-- <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>s -->
            ...
            <div class="bg-white p-5 mx-5 my-5" style="max-width: 500px">
                <div class="flex justify-between items-center pb-8">
                    <h1 class="font-semibold text-gray-600 text-xl">Add new edit_event</h1>
                    <i class="fas fa-close text-gray-300 cursor-pointer" onclick="toggleModal('edit_event')"></i>
                </div>
                <form action="../events/modals/events_modal_process.php" method="POST">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" value="<?php echo $eDescription ?>" autocomplete="off" name="eDescription"class="bg-gray-100 focus:outline-none border-none focus:bg-gray-200 rounded py-2 px-2 text-gray-500 w-full">
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="flex justify-center">
                            <div style="font-size: 14px">
                                <button type="button" onclick="toggleModal('edit_event')" class="px-6 py-2 bg-gray-100 rounded text-gray-500">
                                    Cancel
                                </button>

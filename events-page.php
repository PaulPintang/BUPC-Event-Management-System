    ...
    <div class="px-1 md:px-7 lg:px-7 shadow-sm">
          ...
          <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
              ...
              <?php
               if (isset($_SESSION['id']) && (isset($_SESSION['name'])))  {
                 echo '<a href="events-page.php" class="px-4 py-2 mt-2 text-yellow-400 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 text-yellow-500 focus:text-yellow-500 bg-yellow-200 focus:bg-yellow-200 focus:outline-none focus:shadow-outline">Events</a>';
